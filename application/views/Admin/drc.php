<div class="row">
    <div class="col-md">
        <div class="alert alert-success" role="alert">
            <h4 class="text-uppercase font-weight-bold text-center">Disaster Recovery Center (drc) <br> PUSDATIN SALEMBA</h4>
        </div>
    </div>
</div>
                            ...
                            ?>
                                ...
                                <td>
                                    <h5 class="text-center">
                                        <a class="btn btn-sm btn-primary text-uppercase font-weight-bold" href="<?= base_url() ?>Dashboard/detail_drc/<?= $row['id_personil']; ?>">Detail</a>
                                    </h5>
                                </td>
                        </tr>
                    <?php } ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?= form_open_multipart('Dashboard/simpan_drc'); ?>
