                            ...
                            ?>
                                ...
                                <td>
                                    <h5 class="text-center">
                                        <a class="btn btn-sm btn-primary text-uppercase font-weight-bold" href="<?= base_url() ?>Dashboard/detail_eos_isp/<?= $row['id_personil']; ?>">Detail</a>
                                    </h5>
                                </td>
                        </tr>
                    <?php } ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?= form_open_multipart('Dashboard/simpan_eos_isp'); ?>
